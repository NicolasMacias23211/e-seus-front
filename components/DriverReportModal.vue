    ...
    >
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <h2 class="text-xl font-bold text-white">Reporte Driver</h2>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <div class="text-sm font-semibold text-slate-800">
                Incluir todo el Equipo
              </div>
              <div class="text-xs text-slate-500">
                Genera el reporte para todos los miembros
              </div>
            </div>
          </div>
          <button
            @click="includeTeam = !includeTeam"
            :class="[
              'relative w-14 h-8 rounded-full transition-colors duration-300',
              includeTeam ? 'bg-[#50bdeb]' : 'bg-slate-300',
            ]"
          >
            <div
              :class="[
                'absolute top-1 w-6 h-6 bg-white rounded-full shadow-md transition-transform duration-300',
                includeTeam ? 'translate-x-7' : 'translate-x-1',
              ]"
            ></div>
          </button>
        </div>
