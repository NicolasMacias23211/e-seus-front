<template>
  ...
  >
    ...
    <div class="flex items-center gap-2">
      <button
        class="p-2.5 rounded-xl hover:bg-slate-100 text-slate-600 transition-all hover:shadow-sm"
        title="Ayuda"
      >
      ...
      <div class="relative">
        <button
          class="p-2.5 rounded-xl hover:bg-slate-100 relative transition-all hover:shadow-sm"
        ...
        >
          ...
          <div class="max-h-96 overflow-y-auto">
            <button
              ...
              :key="notification.id"
              class="w-full px-5 py-4 hover:bg-slate-50 text-left border-b last:border-b-0 transition-colors group"
            >
              <p
      ...
      <div class="relative">
        <button
          class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-slate-100 transition-all hover:shadow-sm border-2 border-transparent hover:border-slate-200"
        ...
        >
          ...
          <button
            class="w-full px-5 py-3 hover:bg-slate-50 text-left text-sm font-semibold flex items-center gap-3 transition-colors text-slate-700 hover:text-[#021C7D]"
          >
            <User class="h-4 w-4" />
            Perfil
          </button>
          <button
            class="w-full px-5 py-3 hover:bg-slate-50 text-left text-sm font-semibold transition-colors text-slate-700 hover:text-[#021C7D]"
          >
            ⚙️ Configuración
          </button>
          <div class="border-t-2">
            <button
              class="w-full px-5 py-3 hover:bg-red-50 text-left text-sm font-bold text-red-600 hover:text-red-700 transition-colors"
            >
              🚪 Cerrar Sesión
            </button>
          </div>
