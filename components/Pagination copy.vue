<template>
  <div
    class="col-12 flex items-center justify-between border-t border-white/10 px-4 py-3 sm:px-6"
  >
    <div class="flex flex-1 justify-between sm:hidden">
      <button
        :disabled="
          pagination.center == pagination.firstPage || pagination.totalPages < 2
        "
        ...
        class="relative inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium transition-colors"
      >
        Anterior
      </button>
      <button
      ...
      <div>
        ...
        >
          <button
            type="button"
            :disabled="
              pagination.center == pagination.firstPage ||
          ...
          <span
            ...
            class="relative z-10 inline-flex items-center px-2 py-2 text-sm text-black-400 cursor-default"
            >...</span
          >
          ...
          <input
            ...
            :disabled="
              !pagination.next || pagination.currentPage == pagination.next
            "
...
function recalculate() {
  const totalPages = Math.max(
    1,
    Math.ceil(props.totalRegisters / pagination.value.perPage),
  );
  ...
  if (
    pager.currentPage == pager.firstPage ||
    pager.currentPage == pager.firstPage + 1
  ) {
...
function changePerPage(event: Event) {
  pagination.value.perPage = parseInt(
