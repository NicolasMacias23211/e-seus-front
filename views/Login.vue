<template>
  ...
  >
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        class="absolute top-20 left-10 w-72 h-72 bg-white/5 rounded-full blur-3xl animate-pulse"
      ></div>
      <div
        class="absolute bottom-20 right-10 w-96 h-96 bg-[#50bdeb]/20 rounded-full blur-3xl animate-pulse"
        style="animation-delay: 1s"
      ></div>
      <div
        class="absolute top-1/2 left-1/2 w-64 h-64 bg-white/5 rounded-full blur-3xl animate-pulse"
        style="animation-delay: 2s"
      ></div>
      <div
        class="absolute top-10 right-20 animate-float"
        style="animation-delay: 0.5s"
      >
        <div
          class="w-20 h-20 border-2 border-white/20 rounded-lg rotate-45"
        ></div>
      </div>
      <div
        class="absolute bottom-32 left-16 animate-float-slow"
        style="animation-delay: 1.5s"
      >
        <div class="w-16 h-16 border-2 border-white/15 rounded-full"></div>
      </div>
      <div
        class="absolute top-1/3 left-1/4 animate-float"
        style="animation-delay: 2.5s"
      >
        <div class="w-12 h-12 bg-white/5 rounded-lg rotate-12"></div>
      </div>
      <div
        class="absolute bottom-1/4 right-1/4 animate-float-slow"
        style="animation-delay: 0.8s"
      >
        <div
          class="w-24 h-24 border-2 border-white/10 rounded-xl -rotate-12"
        ></div>
      </div>
      <div
        class="absolute top-1/4 left-10 w-2 h-2 bg-white/30 rounded-full animate-particle"
        style="animation-delay: 0.2s"
      ></div>
      <div
        class="absolute top-1/3 right-20 w-3 h-3 bg-[#50bdeb]/40 rounded-full animate-particle-slow"
        style="animation-delay: 1s"
      ></div>
      <div
        class="absolute bottom-1/3 left-1/3 w-2 h-2 bg-white/25 rounded-full animate-particle"
        style="animation-delay: 1.8s"
      ></div>
      <div
        class="absolute top-2/3 right-1/3 w-3 h-3 bg-white/20 rounded-full animate-particle-slow"
        style="animation-delay: 0.5s"
      ></div>
      <div
        class="absolute bottom-1/4 left-20 w-2 h-2 bg-[#50bdeb]/30 rounded-full animate-particle"
      ...
      <div
        class="absolute bottom-20 right-1/4 animate-float opacity-10"
      ...
      <div
        class="absolute top-1/2 right-16 animate-float-slow opacity-10"
        style="animation-delay: 2s"
      >
        <svg
    ...
    >
      <div
        class="bg-gradient-to-r from-[#021C7D] to-[#50bdeb] px-8 py-12 text-center relative overflow-hidden"
      >
        <div
      ...
      <form @submit.prevent="handleLogin" class="p-8 space-y-6">
        <div class="space-y-2">
          ...
          <div class="relative group">
            ...
            >
              <User
                class="w-5 h-5 text-slate-400 group-focus-within:text-[#50bdeb] transition-colors"
              />
            </div>
            <input
              id="username"
        ...
        <div class="flex items-center justify-between">
          ...
          <a
            href="https://adself.emtelco.co/webclient/index.html?#/selfservice/enrollment"
            class="text-sm text-[#50bdeb] hover:text-[#021C7D] font-medium transition-colors"
          >
